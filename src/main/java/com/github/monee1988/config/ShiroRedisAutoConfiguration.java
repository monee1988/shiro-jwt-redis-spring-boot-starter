...
import com.github.monee1988.redis.CacheManagerProperties;
import com.github.monee1988.redis.RedisManagerProperties;
import com.github.monee1988.redis.RedisSessionDAOProperties;
...
public class ShiroRedisAutoConfiguration {
    ...
    @ConditionalOnProperty(name = "shiro.web.session.redis.enabled", havingValue = "true")
...
//    @ConditionalOnMissingBean
    ...
    @ConditionalOnProperty(name = {"shiro.cache.redis.enabled"},havingValue = "true")
